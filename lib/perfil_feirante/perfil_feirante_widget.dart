...
import 'perfil_feirante_model.dart';
export 'perfil_feirante_model.dart';

class PerfilFeiranteWidget extends StatefulWidget {
  const PerfilFeiranteWidget({super.key});

  static String routeName = 'PerfilFeirante';
  static String routePath = '/perfilFeirante';

  @override
  State<PerfilFeiranteWidget> createState() => _PerfilFeiranteWidgetState();
}
              ...
              children: [
                        ...
                        children: [
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAzUZmwOOdnm-rL-cX75-L9USdZ7EAeMApqw&s',
                                width: 200.0,
                                height: 200.0,
                                fit: BoxFit.cover,
                              ),
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      context.pushNamed(MeusPedidosWidget.routeName);
                    },
                    child: Container(
                      width: double.infinity,
                      height: 60.0,
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context
                                        .pushNamed(MeusPedidosWidget.routeName);
                                  },
                                  child: Text(
                                    'Ver meus pedidos',
                                    style: FlutterFlowTheme.of(context)
