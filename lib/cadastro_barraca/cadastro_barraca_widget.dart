    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (selectedMedia != null &&
        ...
        if (selectedUploadedFiles.length == selectedMedia.length) {
          safeSetState(() {
            _model.uploadedLocalFile_uploadData3yb =
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                'Insira as informações da sua barraca',
                                  ...
                                  children: [
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'Faça upload da imagem da sua barraca',
                                          ...
                                          TextFormField(
                                            ...
                                            cursorColor:
                                                FlutterFlowTheme.of(context)
                                                    .primary,
                                            validator: _model
                                                .nomeProdTextControllerValidator
                                                .asValidator(context),
                                            inputFormatters: [
                                              if (!isAndroid && !isiOS)
                                          ...
                                          TextFormField(
                                            ...
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              labelText: 'Descrição da barraca',
                                              labelStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                                      .override(
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            'Categorias de produto disponíveis na barraca',
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Horário de funcionamento da barraca',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium
