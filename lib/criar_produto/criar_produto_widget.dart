...
class _CriarProdutoWidgetState extends State<CriarProdutoWidget> {
  ...
  // --- LÓGICA DE SALVAR PRODUTO (INALTERADA) ---
  Future<void> _salvarProduto() async {
    ...
    // As verificações originais foram movidas para o validator do formulário.
    ...
    try {
      ...
      Produto novo = Produto(
        ...
        quantidadeEstoque: 10, // Defina um padrão ou crie um campo na tela
          ...
          child: Form(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  // Estrutura de layout do CadastroBarracaWidget
                  Align(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Adicionando formatação de capitalização (opcional)
                              inputFormatters: [ 
                                if (!isAndroid && !isiOS)
                            ...
                            // --- BOTÃO DE SALVAR (FFButtonWidget Formatado) ---
                            FFButtonWidget(
